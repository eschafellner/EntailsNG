...
DEFAULT_TEXTS = {
    ...
    'media_font_family': 'Schriftart',
    'media_font_default': 'Standardschrift',
    'media_manage_fonts': 'Schriftarten verwalten',
    ...
    'media_error_font_choice': 'Feld {index}: unbekannte Schriftart.',
    'media_error_font_missing': 'Eine ausgewählte Schriftart ist nicht mehr verfügbar.',
    'media_error_font_unreadable': 'Eine Schriftdatei konnte nicht gelesen werden.',
    'media_error_font_file_size': 'Die Schriftdatei darf höchstens 5 MB groß sein.',
    'media_error_font_file_format': 'Erlaubt sind TTF, OTF und WOFF2.',
    'media_error_font_file_invalid': 'Die Schriftdatei ist beschädigt oder ungültig.',
